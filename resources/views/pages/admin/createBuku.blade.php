<x-app-layout>
    <div class="mt-5 mx-auto w-3/4 bg-white shadow-md p-5">
        ...
        <form method="POST" action="{{ route('store.buku') }}" class=" space-y-3" enctype="multipart/form-data">
            @csrf
            <input type="text" class="w-full" name="judul" placeholder="Judul">
            <input type="file" class="w-full" name="cover">
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form method="POST" action="{{ route('store.kategori') }}" class="p-4 md:p-5">
                    @csrf
                    <input type="text" name="nama" class="w-full">
                    <button type="submit">Create</button>
                </form>
            </div>
        </div>

<x-app-layout>
    <div class="py-12">
        <form action="{{ route('update.buku', $buku->id) }}" method="POST" enctype="multipart/form-data"
            class="w-4/5 p-5 mx-auto space-y-3 bg-white shadow-md">
            @csrf
            @method('PUT')
            <div class="flex">
                ...
                <div class="w-1/2 space-y-3">
                    ...
                    <input type="text" value="{{ $buku->penulis }}" name="penulis" placeholder="Penulis"
                        class="w-full">
                    ...
                    <input type="number" name="stok" placeholder="Jumlah Stok" class="w-full">
                </div>
            </div>
            <textarea name="sinopsis" id="" cols="30" rows="10" placeholder="Sinopsis" class="w-full rounded-md"></textarea>
